...
export default function RulesModal({ onClose }: { onClose: () => void }) {
  return <div className="modal-backdrop" onClick={onClose}>
    <section className="modal-card" onClick={e => e.stopPropagation()}>
      ...
      <p>Oben bleibt der klassische Zahlenblock unverändert. Ab <strong>63 Punkten</strong> gibt es <strong>35 Bonuspunkte</strong>. Wertest du eine gültige Kategorie im <strong>unteren Teil direkt nach dem 1. Wurf</strong>, bekommst du <strong>+5 Punkte</strong>.</p>
